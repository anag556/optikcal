    ...
    <main className="min-h-screen flex-col">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 flex flex-col md:flex-row gap-12">
        ...
        <div className="md:w-1/3">
          <h1 className="text-3xl font-bold mb-6">Get in Touch with OptiKcal</h1>
          <p className="text-gray-600 mb-8">
            Have questions about our calorie and macro tracking app or need help? We're here for you. Reach out directly via our email.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">kcalopti@gmail.com</p>
              </div>
            </div>
          </div>
